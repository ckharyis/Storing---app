...
class DemoOwnerBootstrapTests(TestCase):
    @override_settings(DEMO_MODE=True)
    def test_bootstrap_creates_first_owner_once(self):
        initial_password = "Unique-demo-owner-passphrase-8472"
        environment = {
        ...
        with mock.patch.dict(os.environ, environment, clear=False):
            call_command("bootstrap_demo_owner")
        ...
        environment["INITIAL_ADMIN_PASSWORD"] = "Different-secure-passphrase-9384"
        with mock.patch.dict(os.environ, environment, clear=False):
            call_command("bootstrap_demo_owner")
    ...
    @override_settings(DEMO_MODE=True)
    def test_bootstrap_requires_deployment_secrets_when_no_owner_exists(self):
