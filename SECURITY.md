...
- Treat Render's free configuration as a temporary fictional-data preview only; its database expires and has no backups.
- Delete `INITIAL_ADMIN_PASSWORD` from Render immediately after the first successful deployment creates the owner account.
